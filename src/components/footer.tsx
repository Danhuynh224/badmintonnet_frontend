    ...
    <footer className="bg-gray-900 dark:bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-gray-300 dark:text-gray-400 mb-4">
              Nền tảng kết nối cộng đồng cầu lông hàng đầu Việt Nam. Tham gia
              ngay để trải nghiệm những tính năng tuyệt vời!
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                href="#"
                className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 block transition-colors"
              >
                Hướng dẫn sử dụng
              </a>
              <a
        ...
        <div className="border-t border-gray-800 dark:border-gray-700 mt-8 pt-8 text-center text-gray-400 dark:text-gray-500">
          <p>&copy; 2024 BadmintonNet. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
