      ...
      <div className="w-full max-w-lg p-8 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 font-medium">
            Đăng ký ngay để bắt đầu hành trình trở thành{" "}
            <span className="text-blue-600 font-bold">NHÀ VÔ ĐỊCH</span> của
            chính mình!
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400 italic">
            Hành trình{" "}
            <span className="text-blue-600 font-semibold">VÔ ĐỊCH</span> bắt đầu
            từ bước đầu tiên!
          </p>
        </div>
      </div>
